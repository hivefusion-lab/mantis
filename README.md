...
<p align="center">
  <a href="https://lab.hivefusion.in/mantis"> <img src="./Mantis.png" alt="Mantis" width="600"> </a>
</p>

USB Mantis is an open-source USB HID platform built by Hivefusion Lab. It allows you to create and run scripts on a simple STM32 Blue Pill development board with an external SPI flash memory.
